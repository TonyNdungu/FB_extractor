...
## Data mining project
## Coctober, 27, 2015
## Script 5: Collecting Facebook data
...
fb_oauth = 'EAACEdEose0cBAJaR4rnBrEE0oZBw8XDETixaGSsgrHQZAyUjMmECt1a7zmrG4VeFQzf8aGZCYv2ZB0wTZCIJcoQ4Ik1Uo1Wo6KQp1mUydE1h7t5aBnbZCnWY3MmiEZBuXGFzZCALkDdLx7YGZBkZATajWvnclngdRDDT2zfPEUlZCSp8OXkdy1fO9zKVYapbPRyoF8ZD'
...
page <- getPage("NCICkenya", token=fb_oauth, n=300) 
...
page <- getPage("YvoteKenya", token=fb_oauth, n=300,
                since='2017/01/01', until='2017/12/30') 
...
post <- getPost(page$id[4], token=fb_oauth, n.comments=1000, likes=FALSE)
